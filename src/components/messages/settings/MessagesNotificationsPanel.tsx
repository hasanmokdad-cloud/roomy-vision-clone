...
interface MessagesNotificationsPanelProps {
  onBack: () => void;
}

export function MessagesNotificationsPanel({ onBack }: MessagesNotificationsPanelProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="h-[60px] px-6 flex items-center gap-6 bg-[#f0f2f5] dark:bg-[#202c33]">
        ...
        <h1 className="text-xl font-medium text-[#111b21] dark:text-[#e9edef]">Messages</h1>
      </div>
