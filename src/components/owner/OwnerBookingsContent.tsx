...
export function OwnerBookingsContent() {
  ...
  return (
    <div className="space-y-6">
                        ...
                        {selectedBooking === booking.id ? (
                          <>
                            <Button
                              ...
                              className="flex-1 md:flex-none bg-gradient-to-r from-primary to-primary/80 text-primary-foreground rounded-xl"
                            >
      ...
      <section>
        <h2 className="text-xl font-semibold text-foreground mb-4">
          Past Viewings ({pastBookings.length})
        </h2>
        <div className="space-y-4">
          {pastBookings.length === 0 ? (
            ...
            pastBookings.slice(0, 5).map((booking, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.05 }}
              >
                <Card className="rounded-2xl shadow-sm opacity-75">
                  <CardContent className="p-6">
