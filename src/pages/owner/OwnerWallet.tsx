          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  All your reservation deposits and payouts
                </CardDescription>
              </CardHeader>
              <CardContent>
                {payoutHistory.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Payouts will appear here when students reserve your rooms.
                    </p>
                  </div>
                ) : (
                          ...
                          <TableRow key={payout.id}>
                            ...
                            <TableCell>
                              <div className="flex items-center gap-2">
                                ...
                                {payout.room?.name || 'Room'}
                              </div>
                            </TableCell>
                            <TableCell>
                              <div className="flex items-center gap-2">
                                <User className="h-4 w-4 text-muted-foreground" />
                                {payout.student?.full_name || 'Student'}
                              </div>
                            </TableCell>
                            <TableCell className="text-right">${payout.deposit_amount.toFixed(2)}</TableCell>
                            <TableCell className="text-right text-orange-600">-${payout.roomy_fee.toFixed(2)}</TableCell>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will remove your payout card. You'll need to add a new one to receive future deposits.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium">{detailsModal.room?.name}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Student</p>
                  <p className="font-medium">{detailsModal.student?.full_name}</p>
                </div>
                <div>
