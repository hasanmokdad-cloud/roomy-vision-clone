...
const Auth = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-6">
      ...
      <Button variant="ghost" className="absolute top-6 left-6 z-10" onClick={() => navigate("/")}>
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-center mb-2">{isLogin ? "Welcome Back" : "Join Roomy"}</h2>
